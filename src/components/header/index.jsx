                    ...
                    <div className="col-md-12">
                        <div id="site-header-inner">
                            <div id="site-logo" className="clearfix">
                                <div id="site-logo-inner">
                                    <Link to="/" rel="home" className="main-logo">
                                        <img id="logo_header"
                                        style={{    filter: `drop-shadow(0 0 5px rgba(255, 255, 255, 0.7))`, // creates a circular shadow
                                        borderRadius: '50%', // makes the image itself round
                                        boxShadow: 'inset 0 0 5px rgba(655, 255, 55, 0.2)',}}
                                        className='logo-dark' src={dove00} alt="Holy Spirit" />
                                    </Link>
                                </div>
                            </div>
                            ...
                            <div className="header-right">
                                ...
                                <div >
                                    <Button style={{margin:'5px'}} variant="primary" href="https://twitter.com/HolySpiritERC20">
                                        <i className="fab fa-twitter"></i>
                                    </Button>
                                    <Button variant="success" href="https://t.me/HolySpiritERC20">
